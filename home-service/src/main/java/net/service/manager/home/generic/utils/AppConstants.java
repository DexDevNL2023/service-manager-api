...
public class AppConstants {
    ...
    public static final String DefaultPackageName = "net.service.manager.home";
    ...
    @Value("${web.address}")
    public static String WEB_ADRESS;
    @Value("${web.port}")
    public static int WEB_PORT;
    public static String WEB_URL = "https://" + WEB_ADRESS + ":" + WEB_PORT;
