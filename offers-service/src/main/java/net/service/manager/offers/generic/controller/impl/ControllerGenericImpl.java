package net.service.manager.offers.generic.controller.impl;
...
import net.service.manager.offers.generic.dto.reponse.RessourceResponse;
import net.service.manager.offers.generic.dto.request.BaseRequest;
import net.service.manager.offers.generic.dto.request.SearchRequest;
import net.service.manager.offers.generic.entity.audit.BaseEntity;
import net.service.manager.offers.generic.exceptions.InternalException;
...
import net.service.manager.offers.generic.utils.GenericUtils;
import net.service.manager.offers.rest.client.AuthorizationService;
import net.service.manager.offers.rest.model.DroitAddRequest;
...
public abstract class ControllerGenericImpl<D extends BaseRequest, R extends BaseReponse, E extends BaseEntity<E, D>> implements ControllerGeneric<D, R, E> {
    ...
    public ResponseEntity<RessourceResponse> deleteById(@NotNull @PathVariable("id") Long id) {
        try {
            ...
            service.delete(authorizationService.hasCurrentUserThisAuthority("admin"), id);
    ...
    public ResponseEntity<RessourceResponse> deleteAll(@NotEmpty @RequestParam(value = "id") List<Long> ids) {
        try {
            ...
            service.deleteAll(authorizationService.hasCurrentUserThisAuthority("admin"), ids);
            return new ResponseEntity<>(new RessourceResponse("Suppression de donnée effectuée avec succès!"), HttpStatus.OK);
        } catch (InternalException e) {
            return new ResponseEntity<>(new RessourceResponse(false, "Erreur de suppression de donnée.\n\n Cause : " + e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
        }
