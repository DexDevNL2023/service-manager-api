package net.service.manager.auth.generic.exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleAuthenticationException(AuthenticationException ex) {
        return new ResponseEntity<>(new RessourceResponse(false, "Erreur d'authentification. Cause : " + ex.getMessage()), HttpStatus.UNAUTHORIZED);
    }

    @ExceptionHandler(AccessDeniedException.class)
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    @ResponseBody
    public ResponseEntity<?> handleTokenAccessDeniedException(AccessDeniedException ex) {
        return new ResponseEntity<>(new RessourceResponse(false, "Erreur d'authentification. Cause : " + ex.getMessage()), HttpStatus.UNAUTHORIZED);
    }
}
