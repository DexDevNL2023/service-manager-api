package net.service.manager.contact.rest.client;

import jakarta.validation.Valid;
import jakarta.validation.constraints.NotEmpty;
import jakarta.validation.constraints.NotNull;
import net.service.manager.contact.generic.client.GenericFallbackFactory;
import net.service.manager.contact.generic.config.FeignConfiguration;
